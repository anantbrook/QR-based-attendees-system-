...
export const sessions = pgTable("sessions", {
  ...
  return [
    // ⚡ Bolt: Added index to optimize getSessionsByInstructor queries (reduces scan from O(n) to O(log n))
    index("sessions_instructor_id_idx").on(table.instructorId),
  ];
});
...
export const participants = pgTable("participants", {
  ...
  return [
    // ⚡ Bolt: Added index to optimize getParticipantsBySession queries
...
export const attendance = pgTable("attendance", {
  ...
  return [
    // ⚡ Bolt: Added index to optimize getAttendanceBySession queries
